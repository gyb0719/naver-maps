...
export default async function handler(req, res) {
    ...
    try {
        ...
        // 🎯 검증된 VWorld API 키들 - 작동하는 키 우선순위
        const apiKeys = [
            'E5B1657B-9B6F-3A4B-91EF-98512BE931A1', // ✅ 검증 완료 - 최우선
            key || 'E5B1657B-9B6F-3A4B-91EF-98512BE931A1', // 클라이언트 키 (fallback은 작동하는 키)
            'CEB482F7-CF7C-333B-B02C-4E7111C3AC77', // 공식 개발자 키 (재검증 필요)
            '12A51C12-8690-3559-9C2B-9F705D0D8AF3', // 기존 키 (INCORRECT_KEY 상태)
            '6BF0B0F9-FB8F-3415-B5A3-5A5D1F8ED2EF'  // 추가 백업 키
        ];
